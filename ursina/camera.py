...
class Camera(Entity):
    def __init__(self):
        ...
        self.fov = 1
        # Clamp UI scale so it never becomes wider than the viewport.
        # In portrait (aspect_ratio < 1) 1/aspect_ratio would be > 1, which makes
        # the UI overflow and get cropped left/right in iOS standalone web apps.
        self.ui = Entity(name='ui', z=-100, scale_x=1/max(1, self.aspect_ratio))
